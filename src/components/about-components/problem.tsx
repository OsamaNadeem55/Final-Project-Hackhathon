    ...
    <div className="flex flex-col items-center mt-11 px-6 wrapper">
      ...
      <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-32 mt-16 mx-6 sm:mx-24">
        <div className="text-center">
          <h3 className="font-bold text-[#252B42] text-[48px] sm:text-[58px]">20K</h3>
        ...
        <div className="text-center">
          <h3 className="font-bold text-[#252B42] text-[48px] sm:text-[58px]">20</h3>
          <h2 className="font-bold text-[#737373] text-[14px] sm:text-[16px]">
          Worldwide Countries
          </h2>
        </div>
        <div className="text-center">
          <h3 className="font-bold text-[#252B42] text-[48px] sm:text-[58px]">80+</h3>
          <h2 className="font-bold text-[#737373] text-[14px] sm:text-[16px]">
            Top Partners
          </h2>
        </div>
