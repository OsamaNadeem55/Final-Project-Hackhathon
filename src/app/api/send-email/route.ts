  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #333;">
        ...
        <p>Thank you for shopping with <strong>Bandage Online Store</strong>! 🛍️</p>
        ...
        <p>If you have any questions or need assistance, feel free to contact us at <a href="mailto:osama5@gmail.com" style="color: #4CAF50; text-decoration: none;">osama5@gmail.com</a> or call us at <strong>+44-225-7879</strong>.</p>

        <p>Thank you again for choosing <strong>Bandage Online Store</strong>! We appreciate your trust in us.</p>
